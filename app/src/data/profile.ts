...
export function getProfile(lang = 'fr', filter?: CvProfileFilter): LinkedInProfile {
  ...
  return {
    ...
    lastName: b.lastName,
    headline: pick(b.headline, (b as unknown as Record<string, string>)['headline_en'], lang),
    summary: pick(b.summary, (b as unknown as Record<string, string>)['summary_en'], lang),
    photoUrl: b.photoUrl,
    location: b.location,
