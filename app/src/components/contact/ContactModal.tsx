...
export function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const url = 'https://github.com/' + GITHUB_CONFIG.owner + '/' + GITHUB_CONFIG.repo + '/issues/new?title=' + title + '&body=' + body + '&labels=contact';
                ...
                {tab === 'whatsapp' ? (
                  ...
                  <form className="modal__form" onSubmit={handleSubmit} noValidate>
                    <div className="form-field">
                      ...
                      />
                      {errors.senderName && (
                        <span className="form-field__error">{errors.senderName}</span>
                      )}
                    </div>
